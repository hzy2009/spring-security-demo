package com.codingmobi.ui.core.utils.mybatis;
...
public class PaginationInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation inv) throws Throwable {
        ...
        MetaObject metaStatementHandler = MetaObject.forObject(inv.getTarget(), DEFAULT_OBJECT_FACTORY, DEFAULT_OBJECT_WRAPPER_FACTORY);
        ...
        if (mappedStatement.getId().matches(pageSqlId)) {
            ...
            if (paramObj == null) {
                ...
                if(paramObj instanceof PageView){
                    ...
                    MetaObject paramObjProxy = MetaObject.forObject(paramObj, DEFAULT_OBJECT_FACTORY, DEFAULT_OBJECT_WRAPPER_FACTORY);
    ...
    private void setRowCount(Invocation invk, MappedStatement mappedStatement, BoundSql boundSql, Object paramObj, PageView<?> pageView) throws SQLException {
        ...
        try {
            ...
            MetaObject boundSqlPoxy = MetaObject.forObject(boundSql, DEFAULT_OBJECT_FACTORY, DEFAULT_OBJECT_WRAPPER_FACTORY);
